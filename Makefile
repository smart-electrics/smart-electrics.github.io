...
test-unit: ## Перевірити guard інтеграцій
	sh scripts/run_ruby_test.sh tests/unit/integration_config_test.rb
	sh scripts/run_ruby_test.sh tests/unit/service_contract_test.rb
	sh scripts/run_ruby_test.sh tests/unit/solution_contract_test.rb
	sh scripts/run_ruby_test.sh tests/unit/cinematic_solutions_contract_test.rb
	sh scripts/run_ruby_test.sh tests/unit/smart_home_contract_test.rb
	sh scripts/run_ruby_test.sh tests/unit/cinematic_contract_test.rb
	sh scripts/run_ruby_test.sh tests/unit/physical_scene_contract_test.rb
	sh scripts/run_ruby_test.sh tests/unit/service_studio_contract_test.rb
	sh scripts/run_ruby_test.sh tests/unit/route_content_contract_test.rb
...
check: verify-skills validate-quality-policy test-unit validate-production-assets validate-public-claims validate-route-content validate-services validate-service-studios validate-solutions validate-cinematic-solutions validate-smart-home validate-cinematic-system validate-physical-scene-states validate-cinematic-route-transitions html test-browser ## Повний локальний quality gate
