...
4. Лише після закриття review і повністю зеленої перевірки Sol позначає PR ready та виконує merge commit або активує auto-merge. Auto-merge не активують до проходження цього gate.
