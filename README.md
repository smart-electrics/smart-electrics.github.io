...
Сайт навмисно опубліковано як `noindex`. Ліцензовані та згенеровані
фотореалістичні візуалізації використовуються у «Готових рішеннях» як готові
до реалізації конфігурації; розділ підтверджених проєктів лишається поза
навігацією до появи матеріалів. Formspree та GA4 не активуються, доки власник
не надасть потрібні реквізити й умови обробки даних.
