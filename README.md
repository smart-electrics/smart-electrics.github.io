...
Сайт навмисно опубліковано як `noindex`-сторінку «готується». Контакти,
портфоліо, сертифікати, строки, гарантії, ціни, Formspree та GA4 не з’являться,
доки власник не надасть і не підтвердить відповідні дані.
