...
- Спілкуйся й пиши користувацький контент українською. Для «Готових рішень» дозволені ліцензовані та згенеровані візуалізації без людей і без видимої AI-позначки; описуй їх як готові до реалізації конфігурації. Не вигадуй сертифікати, ціни, строки, гарантії, адреси, відгуки чи можливості.
